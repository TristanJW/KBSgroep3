...
public class HuidigeConfiguratie {
    ...
    public void maakCombinatie(int aantal,double percentage){
        ...
        //vragen aan jasper of een netwerk altijd moet bestaan uit een firewall en loadbalancer
        //voor elk aanbod van netwerkcomponent wordt de naam in een array gezet.
        //deze naam wordt gebruikt om vervolgens het netwerkcomponent in een aanbod ArrayList te zoeken.
    ...
    public NetwerkComponent zoekOpNaam(String term, ArrayList<NetwerkComponent> aanbod){
        ...
        //voor elke entry in de arraylist kijken of de naam, bijvoorbeeld HALW9001 gelijk is 
